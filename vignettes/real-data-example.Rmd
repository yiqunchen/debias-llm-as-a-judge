...
results <- tibble(
  ...
  Estimate = c(
    ...
    rg_result$theta,
    eif_result$theta,
    mle_result$theta_hat
  ),
  CI_Lower = c(NA, naive_ci[1], ppi_result$ci_lower, ppi_pp_result$ci_lower,
               rg_result$ci_lower, eif_result$ci_lower, mle_result$ci_theta_obs[1]),
  CI_Upper = c(NA, naive_ci[2], ppi_result$ci_upper, ppi_pp_result$ci_upper,
               rg_result$ci_upper, eif_result$ci_upper, mle_result$ci_theta_obs[2])
) %>%
  mutate(
