...
# =============================================================================
# Simulation Configuration for K=3
# =============================================================================
...
generate_pi_true <- function(pi1, K) {
  remaining <- 1 - pi1
  # Split remaining mass: class 2 gets 60%, class 3+ gets 40%/(K-2)
  if (K == 3) {
    pi <- c(pi1, remaining * 0.6, remaining * 0.4)
  } else {
    pi <- c(pi1, remaining * 0.5, rep(remaining * 0.5 / (K - 2), K - 2))
  }
